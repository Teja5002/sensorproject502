...
class DataTransformationConfig:
    ...
    transformation_train_file_path = os.path.join(artifact_dir,'train.npy')
    transformation_test_file_path = os.path.join(artifact_dir,'test.npy')
    transformation_object_file_path = os.path.join(artifact_dir,'preprocessing.pkl')

class DataTransformation:
    def __init__(self,feature_store_file_path):
        self.feature_staore_file_path =feature_store_file_path
    ...
    def get_data_transformer_object(self):
        try:
            imputer_step=('imputer',SimpleImputer(statergy='constant',fill_values=0))
    ...
    def initiate_data_transformation(self):
        ...
        try:
            dataframe = self.get_data(feature_store_file_path=self.feature_staore_file_path)
